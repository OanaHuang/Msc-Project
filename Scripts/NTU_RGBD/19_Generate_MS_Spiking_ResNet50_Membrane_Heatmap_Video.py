...
# Model 18 was trained with skeleton-guided person crops.
PERSON_CROP = True
BBOX_EXPANSION = 0.25
...
def main() -> None:
    ...
    print()
    print("=" * 72)
    print("NTU RGB+D MS-Spiking ResNet50 membrane-readout video generation")
    print("=" * 72)
    print(f"Model version:       {MODEL_VERSION}")
    print("Readout type:        Mean membrane potential")
