# Scripts/NTU_RGBD/20_Train_SpikeYOLO_Style_LIF_Heatmap.py
...
from Scripts.NTU_RGBD.models.SpikeYOLO_Style_LIF_Heatmap import (
...
OUTPUT_DIR = (
    NTU_RGBD_OUTPUT_DIR
    / "20_Train_SpikeYOLO_Style_LIF_Heatmap"
)
OUTPUT_DIR.mkdir(
    parents=True,
    exist_ok=True,
...
# None uses all videos.
MAX_TRAIN_VIDEOS = None
MAX_VAL_VIDEOS = None

# Use every fifth frame, matching the earlier NTU training.
FRAME_STRIDE = 5

# Standard LIF settings.
NUM_STEPS = 2
BETA = 0.90
THRESHOLD = 1.0
SURROGATE_SLOPE = 25.0

# This architecture is randomly initialized.
PRETRAINED = False
READOUT_TYPE = "mean_spike"
...
# Set to 0, 1, 2... to force a CUDA GPU.
# Leave as None to use the project device helper.
DEVICE_NAME = None
...
def main() -> None:
    ...
    print(
        "NTU RGB+D Model 20: "
        "SpikeYOLO-Style Standard-LIF Heatmap"
    )
    print("=" * 72)
    ...
    print()
    print("=" * 72)
    print("Model 20 training completed")
    print("=" * 72)
