# Scripts/NTU_RGBD/21_Train_SpikeYOLO_Style_ILIF_Heatmap.py
...
# I-LIF integer range: 0, 1, 2, 3, 4.
MAX_SPIKES = 4

PRETRAINED = False
READOUT_TYPE = "mean_integer_spike"
...
def main() -> None:
    ...
    print(f"Maximum spikes D:   {MAX_SPIKES}")
    print(f"Integer values:     0..{MAX_SPIKES}")
    ...
    print()
    print("=" * 72)
    print("Model 21 training completed")
    print("=" * 72)
