# Scripts/NTU_RGBD/12_Train_ResNet50_Heatmap_Human_Detection.py
...
# ============================================================
# 5. Human detection / person crop configuration
# ============================================================

# Current implementation uses NTU skeleton keypoints
# to generate a person bounding box.
#
# This is not yet an external detector such as YOLO.
PERSON_CROP = True
